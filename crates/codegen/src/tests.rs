...
use hir_ty::{attach_db, next_solver::GenericArgs};
use span::Edition;
use test_fixture::WithFixture;

use crate::{JitEngine, MonoFunction, test_db::TestDB};
...
fn eval_fn_i32(db: &TestDB, file_id: EditionedFileId) -> Result<i32, String> {
    attach_db(db, || {
        ...
        let mono_func_id = MonoFunction::new(db, func_id, GenericArgs::default());
